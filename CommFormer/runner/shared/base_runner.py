...
from CommFormer.utils.shared_buffer import SharedReplayBuffer
from CommFormer.algorithms.mat.mat_trainer import MATTrainer as TrainAlgo
from CommFormer.algorithms.mat.algorithm.transformer_policy import TransformerPolicy as Policy
...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        if self.use_wandb:
            ...
            self.run_dir = config["all_args"].run_dir
